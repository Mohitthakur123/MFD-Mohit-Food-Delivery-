...
const TopNav = () => {
  ...
  useEffect(() => {
    const fatchAdmin = async () => {
      const { data } = await axios.get(`https://mfd-mohit-food-delivery.onrender.com/api/admin/users/${id}`);
      setAdmin(data);
    };
    fatchAdmin();
  }, [admin]);
  ...
  const logout = () => {
    ...
    window.location.href = "https://mfd-mohit-food-delivery.onrender.com/";
  };
