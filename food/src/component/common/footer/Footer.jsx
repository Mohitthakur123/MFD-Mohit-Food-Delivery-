  ...
  return (
    <>
      <footer>
        <div className="container padding grid-4">
          <div className="box footer-logo">
            <img src="https://mfd-mohit-food-delivery.onrender.com/default/logo.png" />
            <p>
          ...
          <div className="box last">
            ...
            <ul>
              <li>
                ...
                Sukh Enclave Aujala kharar Punjab
              </li>
              <li>
      ...
      <div className="copyright">
        <p>
          &copy; Copyright 2023 All Right Reserve. By <span>Mohit Thakur</span>
        </p>
        <Link
          id="back-to-top"
